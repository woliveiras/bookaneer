    ...
    <Card>
      ...
      <CardContent className="space-y-6">
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              Usenet only: Minimum age of releases before they are grabbed. Use to give new releases time to propagate.
            </p>
          </div>
          ...
          {/* RSS Sync Interval */}
          <div className="space-y-2">
            <Label htmlFor="rssSyncInterval" className="text-amber-500">RSS Sync Interval</Label>
            <div className="flex items-center gap-2">
              <Input
                id="rssSyncInterval"
                type="number"
        ...
        <div className="flex justify-end pt-4 border-t">
          <Button
            onClick={handleSave}
            disabled={!isDirty || updateOptions.isPending}
          >
